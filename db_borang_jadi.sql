...
insert  into `keikutsertaan_org`(`id`,`id_dosen`,`nm_organisasi`,`thn_awal`,`thn_akhir`,`internasional`,`nasional`,`lokal`) values (1,'1','APTIKOM',2018,2019,'',NULL,NULL),(2,'2','APTIKOM',2018,2019,'',NULL,NULL),(3,'3','APTIKOM',2018,2019,'',NULL,NULL),(4,'4','APTIKOM',2018,2019,'',NULL,NULL),(5,'4','Ikatan Ahli Informatika Indonesia (IAII)',2016,2018,NULL,'v',NULL),(6,'5','APTIKOM',2018,2019,'',NULL,NULL),(7,'1','ITB',2017,2018,NULL,NULL,'v');
...
insert  into `pkdt_tgs_belajar`(`id_dosen`,`jenjang_pend`,`bid_studi`,`perguruan_tinggi`,`negara`,`thn_mulai_std`,`id`) values ('4','S1','Elektro dan Informatika','Institut Teknologi Bandung','Indonesia','2017',1),('2','S3','Teknik Informatika','Institut Teknologi Bandung','Indonesia','2018',2);
...
insert  into `users`(`id`,`username`,`password`,`kd_prodi`) values (1,'admin','teguh',NULL),(2,'d3','d3mi','p001'),(3,'s1','s1',NULL),(4,'s1','ti',NULL);
