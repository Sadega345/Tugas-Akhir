...
public function index() {
 ...
 $data=$this->Apd_a441_model->listing();
 $this->load->view('User/Butir4/tampilan_borang4.4.1.php',array('data'=>$data));
 }

 public function ubah($nidn){
 	$this->model_squrity->getsqurity();
		$res=$this->Apd_a441_model->update("where nidn='$nidn'");
		$data=array(
 	...
 	$this->load->view('User/Butir4/edit_borang4.4.1.php',$data);
 }
 ...
 public function do_edit(){
		...
		$res=$this->Apd_a441_model->rubah('dosen_tbl',$data_update,$where);
		if ($res>=1) {
			redirect('Apd_a441_excel');
		}
 		// echo "Masuk";
		// else {
		// 	alert("Gagal Update") ;
...
public function export_excel(){
 ...
 // 'a441' => $this->apd_a441_model->listing());
 $data=$this->Apd_a441_model->listing();
 $this->load->view('User/Butir4/tampilan_borang4.4.1_excel.php',array('data'=>$data));
 }
