...
public function index() {
 ...
 $totalnonreg1=$this->Aps_b312_model->totalnonreg1();
 $listnonreg1=$this->Aps_b312_model->listnonreg1();
 $totalnonreg2=$this->Aps_b312_model->totalnonreg2();
 $listnonreg2=$this->Aps_b312_model->listnonreg2();
 $totalnonreg3=$this->Aps_b312_model->totalnonreg3();
 $listnonreg3=$this->Aps_b312_model->listnonreg3();
 $this->load->view('Users/Butir3B/tampilan_borang3.1.2.php',array('prodi' => $prodi,
																...
																'total3'=>$total3,
																'data3'=>$data3,
																'totalnonreg1'=>$totalnonreg1,
																'listnonreg1'=>$listnonreg1,
																'totalnonreg2'=>$totalnonreg2,
																'listnonreg2'=>$listnonreg2,
																'totalnonreg3'=>$totalnonreg3,
																'listnonreg3'=>$listnonreg3
															));
 }
