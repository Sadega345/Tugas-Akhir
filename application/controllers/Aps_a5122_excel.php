...
public function index() {
 ...
 $totalkuliah=$this->Aps_a5122_model->totkuliah();
 $totalpraktikum=$this->Aps_a5122_model->totpraktikum();
 $totaltugas=$this->Aps_a5122_model->tottugas();
 $totalskripsi=$this->Aps_a5122_model->totskripsi();
 $totalsilabus=$this->Aps_a5122_model->totsilabus();
 $totalsap=$this->Aps_a5122_model->totsap();
...
public function do_tambah(){
	...
	public function ubah($kode_mk){
 	$this->model_squrity->getsqurity();
		$res=$this->Aps_a5122_model->update("where kode_mk='$kode_mk'");
		$data=array(
			"smt"=>$res[0]['smt'],
