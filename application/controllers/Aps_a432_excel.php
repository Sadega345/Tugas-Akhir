...
public function index() {
 ...
 $data=$this->Aps_a432_model->listing();
 $this->load->view('Users/Butir4/tampilan_borang4.3.2.php',array('data'=>$data));
 }

 public function ubah($nidn){
 	$this->model_squrity->getsqurity();
	$res=$this->Aps_a432_model->update("where nidn='$nidn'");
	$data=array(
 	...
 	$this->load->view('Users/Butir4/edit_borang4.3.2.php',$data);
 }
 ...
 public function do_edit(){
		...
		$res=$this->Aps_a432_model->rubah('dosen_tbl',$data_update,$where);
		if ($res>=1) {
			redirect('Aps_a432_excel');
		}
		// else {
		// 	alert("Gagal Update") ;
		// }
...
public function export_excel(){
 ...
 $data=$this->Aps_a432_model->listing();
 $this->load->view('Users/Butir4/tampilan_borang4.3.2_excel.php',array('data'=>$data));
 }
