...
public function index() {
 ...
 public function ubah($id){
 	...
 	$res=$this->Apd_b711_model->update("where id='$id'");
 	$data=array(
 	...
 	$this->load->view('User/Butir7B/edit_borang7.1.1.php',$data);
 }
 ...
 public function do_edit(){
		...
		$where=array('id'=>$id);
		$res=$this->Apd_b711_model->rubah('penelitian_dosen',$data_update,$where);
		if ($res>=1) {
			redirect('Apd_b711_excel');
		}
		// else {
		// 	alert("Gagal Update") ;
		// }
