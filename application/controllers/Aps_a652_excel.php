...
public function index() {
 ...
 public function ubah($id){
	...
	$res=$this->Aps_a652_model->update("where id='$id'");
	$data=array(
		"manual"=>$res[0]['manual'],
		"id"=>$res[0]['id'],
 	...
 	$this->load->view('Users/Butir6/edit_borang6.5.2.php',$data);
 }
 ...
 public function do_edit(){
		...
		$where=array('id'=>$id);
		$res=$this->Aps_a652_model->rubah('aksesbilitas_data',$data_update,$where);
		// print_r($data_update);die;
		if ($res>=1) {
			redirect('Aps_a652_excel');
		}
		// else {
		// 	alert("Gagal Update") ;
		// }
...
public function export_excel(){
 ...
 $totallan=$this->Aps_a652_model->totlan();
 $totalwan=$this->Aps_a652_model->totwan();
 $this->load->view('Users/Butir6/tampilan_borang6.5.2_excel.php',array('data1'=>$data1,
 																'totmanual'=>$totalmanual,
																'totkomp'=>$totalkomp,
																'totlan'=>$totallan,
																'totwan'=>$totalwan));
