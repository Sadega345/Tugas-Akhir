...
public function index() {
 ...
 $this->load->view('Users/PengisiProdi/tampilan_pengisiprodi.php',array('data'=>$data));
 }

 public function ubah(){
 	$this->model_squrity->getsqurity();
 	$id = 1;
 	$res=$this->Prodis_model->update("where id='$id'");
	$data=array(
 	...
 	$this->load->view('Users/PengisiProdi/edit_pengisiprodi.php',$data);
 }
 ...
 public function do_edit(){
		...
		$where=array('id'=>$id);
		$res=$this->Prodis_model->rubah('PRODI_TBL',$data_update,$where);
		// print_r($data_update);die;
		if ($res>=1) {
			redirect('Prodis_excel');
		}
		// else {
		// 	alert("Gagal Update") ;
		// }
...
public function export_excel(){
 ...
 // 'prodi' => $this->Prodis_model->listing());
	$data = $this->Prodis_model->listing();
 $this->load->view('Users/PengisiProdi/tampilan_pengisiprodi_excel.php',array('data'=>$data));
 }
