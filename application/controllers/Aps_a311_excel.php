...
public function index() {
 ...
 $data=$this->Aps_a311_model->listing();

 $jumdtampung=$this->Aps_a311_model->jumdtampung();
$iseleksi=$this->Aps_a311_model->iseleksi();

$barutransfer=$this->Aps_a311_model->barutransfer();
$totbukantransfer=$this->Aps_a311_model->totbukantransfer();

$tottransfer=$this->Aps_a311_model->tottransfer();
$lulusanregbukantransfer=$this->Aps_a311_model->lulusanregbukantransfer();

$jumlulusantransfer=$this->Aps_a311_model->jumlulusantransfer();
$rata=$this->Aps_a311_model->rata();
$llsseleksi=$this->Aps_a311_model->llsseleksi();
$barubkntransfer=$this->Aps_a311_model->barubkntransfer();

 $this->load->view('Users/Butir3/tampilan_borang3.1.1.php',array('data'=>$data,
 ...
 // 	$data=$this->Aps_a311_model->listing();
	...
	// $this->load->view('Users/Butir3/edit_borang3.1.1.php',array('data'=>$data,
 ...
 public function ubah($id){
	...
	$res=$this->Aps_a311_model->update("where id='$id'");
	$data=array(
 	...
 	$this->load->view('Users/Butir3/edit_borang3.1.1.php',$data);
 }
 ...
 public function do_edit(){
		...
		$where=array('id'=>$id);
		$res=$this->Aps_a311_model->rubah('DATA_MHS',$data_update,$where);
		// print_r($data_update);die;
		if ($res>=1) {
			redirect('Aps_a311_excel');
		}
		// else {
		// 	alert("Gagal Update") ;
		// }
 ...
 // public function do_edit(){
	...
	// 		'PRSN_IPK3'=>$PRSN_IPK3
	// 	);
	// 	$res=$this->Aps_a311_model->insert('DATA_MHS',$data_insert);
	// 	if ($res>=1) {
...
$llsseleksi=$this->Aps_a311_model->llsseleksi();
$barubkntransfer=$this->Aps_a311_model->barubkntransfer();
 $this->load->view('Users/Butir3/tampilan_borang3.1.1_excel.php',array('data'=>$data,
