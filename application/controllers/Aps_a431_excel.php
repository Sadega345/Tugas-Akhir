...
public function index() {
 ...
 $data=$this->Aps_a431_model->listing();		
 $this->load->view('Users/Butir4/tampilan_borang4.3.1.php',array('data'=>$data));
 }

 public function ubah($nidn){
 	$this->model_squrity->getsqurity();
	$res=$this->Aps_a431_model->update("where nidn='$nidn'");
	$data=array(
...
public function export_excel(){
 ...
 // 'a431' => $this->Aps_a431_model->listing());
 $data=$this->Aps_a431_model->listing();		
 $this->load->view('Users/Butir4/tampilan_borang4.3.1_excel.php',array('data'=>$data));
 }

 public function rubah(){
 	$data['data']=$this->Aps_a431_model->listing();	
 	// print_r($data);die;
 	$data['list']=$this->Aps_a431_model->JabAkademik();
 	 // print_r($data['list']);die;
 $this->load->view('Users/Butir4/edit_borang_semua4.3.1.php',array('data'=>$data));
 }
