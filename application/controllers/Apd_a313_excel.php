...
public function index() {
 ...
 // 'a313' => $this->apd_a313_model->listing());
	...
	$total=$this->Apd_a313_model->jumlah();
 ...
 public function ubah($id){
	...
	$res=$this->Apd_a313_model->update("where id='$id'");
	$data=array(
		"ts_4"=>$res[0]['ts_4'],
		"ts_3"=>$res[0]['ts_3'],
		"ts_2"=>$res[0]['ts_2'],
	...
	if ($id==1) {
		$this->load->view('User/Butir3/edit_borang3.1.3(4).php',$data);
	}else if ($id==2) {
		$this->load->view('User/Butir3/edit_borang3.1.3(3).php',$data);
	}else if ($id==3) {
		$this->load->view('User/Butir3/edit_borang3.1.3(2).php',$data);
	}else if ($id==4) {
		$this->load->view('User/Butir3/edit_borang3.1.3(1).php',$data);
	}else if ($id==5) {
		$this->load->view('User/Butir3/edit_borang3.1.3_ts.php',$data);
	}
 ...
 public function do_edit(){
		...
		$res=$this->Apd_a313_model->rubah('data_mhs_angkatan',$data_update,$where);
		// print_r($data_update);die;
		if ($res>=1) {
			redirect('Apd_a313_excel');
		}
		// else {
		// 	alert("Gagal Update") ;
		// }
