...
public function load(){
 	$data=$this->Data_dosens_model->loadlisting();
	// $data=$this->Apd_a431_model->listing();
	$this->load->view('Users/DataDosen/load_tampilan_dosen.php',array('data'=>$data));
 }

 public function ubahload($nidn){
 	$this->model_squrity->getsqurity();
	$res=$this->Data_dosens_model->updateload("where nidn='$nidn'");
	$data=array(
 	...
 	$this->load->view('Users/DataDosen/edit_dosenload.php',$data);
 }
...
public function tambah_load(){
		...
		// echo $convert;die;
		// print_r($data);
		return $this->load->view('Users/DataDosen/inputan_dosenload.php',array('id_dosen' => $kd_dosen));
	}
	...
	public function do_tambahload(){
		...
		$res=$this->Data_dosens_model->insert('dosen_tbl',$data_insert);
		if ($res>=1) {
			redirect('Data_dosens_excel');
		}else {
			alert('Gagal Insert');
...
public function tambah(){
		...
		// echo $convert;die;
		// print_r($data);
		return $this->load->view('Users/DataDosen/inputan_dosen.php',array('id_dosen' => $kd_dosen));
	}
...
public function do_hapus($nidn){
		$this->model_squrity->getsqurity();
		$where=array('NIDN'=>$nidn);
		$res=$this->Data_dosens_model->Delete('dosen_tbl',$where);
		if($res>=1){
			redirect('Data_dosens_excel');
		}else {
			alert('Gagal Hapus');
