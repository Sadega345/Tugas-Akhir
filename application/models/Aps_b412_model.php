...
on p.kode_prodi=d.kd_prodi and d.id_dosen=pd.id_dosen where p.kode_fakultas="F001"');
 ...
 $banyak1=$this->db->query('select COUNT(d.nidn) banyak from dosen_tbl d inner join prodi_tbl p on p.kode_prodi=d.kd_prodi where d.kd_jns_dosen=3 and p.kode_prodi="p002";');
 return $banyak1->result_array();
 }
