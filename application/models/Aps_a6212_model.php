...
// Listing
 ...
 public function jmlmhs2() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $data=$this->db->query('select sum(j_tot_reg_bkn_trf) as jmlmhs2 from data_mhs where tahun="2014" and id_prodi='."'$kdprodi'");
 return $data->result_array();
 }

 public function jmlmhs1() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $data=$this->db->query('select sum(j_tot_reg_bkn_trf) as jmlmhs1 from data_mhs where tahun="2015"  and id_prodi='."'$kdprodi'");
 return $data->result_array();
 }

public function jmlmhs() {
	$kdprodi = $this->session->userdata('kd_prodi');
 $data=$this->db->query('select sum(j_tot_reg_bkn_trf) as jmlmhs from data_mhs where tahun="2016"  and id_prodi='."'$kdprodi'");
 return $data->result_array();
 }
