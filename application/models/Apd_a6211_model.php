...
// Listing
 ...
 public function listing2() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $dana2=$this->db->query('SELECT id,jenis_dana,ts_2,ts_1,ts,sum(ts_2+ts_1+ts) as total2 FROM perolehan_dana WHERE id_dana=2 and kd_prodi='."'$kdprodi'");
 return $dana2->result_array();
 }

 public function listing3() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $dana3=$this->db->query('SELECT id,jenis_dana,ts_2,ts_1,ts,sum(ts_2+ts_1+ts) as total3 FROM perolehan_dana WHERE id_dana=3 and kd_prodi='."'$kdprodi'");
 ...
 public function listing5() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $dana5=$this->db->query('select id,jenis_dana,ts_2,ts_1,ts,sum(ts_2+ts_1+ts) as total5 from perolehan_dana where id_dana=5 and kd_prodi='."'$kdprodi'");
 return $dana5->result_array();
 }

 public function listing6() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $dana6=$this->db->query('select id,jenis_dana,ts_2,ts_1,ts,sum(ts_2+ts_1+ts) as total6 from perolehan_dana where id_dana=6 and kd_prodi='."'$kdprodi'");
 ...
 public function listing7() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $dana7=$this->db->query('select id,jenis_dana,ts_2,ts_1,ts,sum(ts_2+ts_1+ts) as total7 from perolehan_dana where id_dana=7 and kd_prodi='."'$kdprodi'");
 return $dana7->result_array();
 }

 public function listing8() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $dana8=$this->db->query('select id,jenis_dana,ts_2,ts_1,ts,sum(ts_2+ts_1+ts) as total8 from perolehan_dana where id_dana=8 and kd_prodi='."'$kdprodi'");
 return $dana8->result_array();
 }

 public function listing9() {
 	$kdprodi = $this->session->userdata('kd_prodi');
 $dana9=$this->db->query('select id,jenis_dana,ts_2,ts_1,ts,sum(ts_2+ts_1+ts) as total9 from perolehan_dana where id_dana=9 and kd_prodi='."'$kdprodi'");
