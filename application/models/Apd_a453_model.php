...
// Listing
 ...
 $data=$this->db->query('SELECT k.id,d.nama_dosen,k.jenis_kegiatan,k.tempat,k.tahun,k.sbg_penyaji,k.sbg_peserta FROM kegiatan_dsn_ttp k INNER JOIN dosen_tbl d ON k.id_dosen=d.id_dosen WHERE d.kd_prodi='."'$kdprodi'".' AND d.kd_jns_dosen=1');
