...
// Listing
 ...
 $data1=$this->db->query('select j_maba_reg_bkn_trf,id from data_mhs where id_prodi="p002" and tahun="2016"');
 ...
 $data2=$this->db->query('select j_maba_trf,id from data_mhs where id_prodi="P002" and tahun="2016"');
 ...
 $data3=$this->db->query('select j_tot_reg_bkn_trf,id from data_mhs where id_prodi="P002" and tahun="2016"');
