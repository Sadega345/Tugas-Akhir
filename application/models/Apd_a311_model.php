...
j_llsn_reg_bkn_trf,j_llsn_trf,ipk_min,ipk_rat,ipk_mak,PRSN_IPK1,PRSN_IPK2,PRSN_IPK3,id FROM DATA_MHS WHERE kd_prog=1 and id_prodi='."'$kdprodi'".'ORDER BY tahun');
