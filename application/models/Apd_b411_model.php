...
$data1=$this->db->query('select jml from sdm where kd_hal=1 and kd_prodi="p001";');
return $data1->result_array();
}

public function listing2() {
$data2=$this->db->query('select jml from sdm where kd_hal=2 and kd_prodi="p001";');
return $data2->result_array();
}

public function listing3() {
$data3=$this->db->query('select jml from sdm where kd_hal=3 and kd_prodi="p001";');
return $data3->result_array();
}

public function listing4() {
$data4=$this->db->query('select jml from sdm where kd_hal=4 and kd_prodi="p001";');
return $data4->result_array();
}

public function listing5() {
$data5=$this->db->query('select jml from sdm where kd_hal=5 and kd_prodi="p001";');
return $data5->result_array();
}

public function listing6() {
$data6=$this->db->query('select jml from sdm where kd_hal=6 and kd_prodi="p001";');
return $data6->result_array();
}

public function listing7() {
$data7=$this->db->query('select jml from sdm where kd_hal=7 and kd_prodi="p001";');
...
$totalaps=$this->db->query('select sum(s.jml) as totalaps from sdm s inner join jns_hal j on j.kd_hal=s.kd_hal where j.jenis="JABFUNG" and kd_prodi="p001"');
...
$totalbps=$this->db->query('select sum(s.jml) as totalbps from sdm s inner join jns_hal j on j.kd_hal=s.kd_hal where j.jenis="dikti" and kd_prodi="p001"');
