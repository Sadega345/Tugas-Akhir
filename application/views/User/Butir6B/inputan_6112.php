<!DOCTYPE html>
<title>Butir 6.1.1.2 : PENGGUNAAN DANA</title>
<!-- 
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Apd_a641_excel/do_tambah"; ?>" method="POST">
							<div class="container">
								<div class="col-md-10">
									<div class="row">
										<div class="form-group">
											<label>Id</label>
											<?php 
												$data=$this->Apd_a641_model->listing1();
												$id = count($data)+1;
									...
									<div class="row">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="jenis_pustaka" >
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label>Jumlah Judul</label>
											<input type="text" class="form-control" name="jml_judul" >
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label>Jumlah Copy</label>
											<input type="text" class="form-control" name="jml_copy">
										</div>
									</div>
									</div>
