				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Apd_a652_excel/do_tambah"; ?>" method="POST">
							<div class="container">
								<div class="col-md-10">
									<div class="row">
										<div class="form-group">
											<label>Id</label>
											<?php 
												$data=$this->Apd_a652_model->listing1();
												$id = count($data)+1;
									...
									<div class="row">
										<div class="form-group">
											<label>Secara Manual</label>
											<input type="checkbox" class="form-control" name="manual" value="v">
										</div>
									</div>

									<div class="row">
										<div class="form-group">
											<label>Dengan Komputer Tanpa Jaringan</label>
											<input type="checkbox" class="form-control" name="komp_tnp_jar" value="v">
										</div>
									</div>
									...
									<div class="row">
										<div class="form-group">
											<label>LAN</label>
											<input type="checkbox" class="form-control" name="lan" value="v">
										</div>
									</div>
									...
									<div class="row">
										<div class="form-group">
											<label>WAN</label>
											<input type="checkbox" class="form-control" name="wan" value="v">
										</div>
									</div>
									</div>
