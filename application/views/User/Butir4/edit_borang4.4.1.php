					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<?php } ?> -->
								<tr>
								 	<td>1</td>
								 	<td><input type="text" name="" value="JUHRIDIN"></td>
								 	<td><input type="text" name=""></td>
								 	<td><input type="text" name="" value="09-03-1980"></td>
								 	<td><input type="text" name=""></td>
								 	<td><input type="text" name="" value="Tidak"></td>
								 	<td><input type="text" name="" value="STAI Siliwangi Bandung"></td>
								 	<td><input type="text" name="" value="Bahasa Inggris"></td>
								 	<td><input type="text" name="" value="S.Pd"></td>
								 	<td><input type="text" name="" value="Pasca Sarjana UIN SGD Bandng"></td>
								 	<td><input type="text" name="" value="PAI"></td>
								 	<td><input type="text" name="" value="M.Ag"></td>
								 	<td><input type="text" name=""></td>
								 	<td><input type="text" name=""></td>
								 	<td><input type="text" name=""></td>
								 </tr>
