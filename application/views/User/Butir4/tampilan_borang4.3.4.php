<!DOCTYPE html>
<title>Butir 4.3.4 : AKTIVITAS MENGAJAR DOSEN TETAP YANG BIDANG KEAHLIANNYA SESUAI DENGAN PS</title>
<!-- 
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Butir 4.3.4 : AKTIVITAS MENGAJAR DOSEN TETAP YANG BIDANG KEAHLIANNYA SESUAI DENGAN PS
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url()."index.php/Apd_a434_excel/tambah";?>">
							...
							?>
							 <tr>
							 	...
							 	<td class="center">
									<a href="<?php echo base_url()."index.php/Apd_a434_excel/ubah/".$d['id'];?>" >Edit</a>
									||
								 		<a href="<?php echo base_url()."index.php/Apd_a434_excel/do_hapus/".$d['id'];?>" id="alerthapus"">Hapus</a>
								</td>
							 </tr>
							 <?php } ?>
							 <?php 
