						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url()."index.php/Apd_a455_excel/tambah";?>">
							...
							?>
							 	...
							 	<td class="center">
									<a href="<?php echo base_url()."index.php/Apd_a455_excel/ubah/".$d['id'];?>" >Edit</a>
									||
									<a href="<?php echo base_url()."index.php/Apd_a455_excel/do_hapus/".$d['id'];?>" >Hapus</a>
								</td>
							 </tr>
							 <?php } ?>
							</tbody>
