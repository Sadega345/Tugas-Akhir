...
<table border="1" width="50%">
		<thead>
								  <tr>
									 ...
									 <th rowspan="2" bgcolor="#D3D3D3"><center>Bidang Keahlian</center></th>
							...
							?>
							 ...
							 ?>
							 <tr>
							 	<td colspan="6" bgcolor="#D3D3D3"><center>Jumlah*</center></td>
							 	<td bgcolor="#7FFF00"><?php echo $jum['jumper_d']; ?></td>
							 <?php } ?>
							 <?php 
							 	foreach ($jumlah2 as $jum2) {
							 ?>
							 	<td bgcolor="#7FFF00"><?php echo $jum2['jumlahpertemuan_dilaksanakan']; ?></td>
							 <?php } ?>
							 </tr>
