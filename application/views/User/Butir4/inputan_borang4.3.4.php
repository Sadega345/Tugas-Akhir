				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Apd_a434_excel/do_tambah"; ?>" method="POST">
							<div class="container">
								<div class="col-md-10">
									<div class="row">
										<div class="form-group">
											...
											<select name="id_dosen" class="form-control">
												...
												<?php 
													$data=$this->Apd_a434_model->getdosen();
													foreach($data as $d) { 
												?>
									...
									<div class="row">
										<div class="form-group">
											...
											<input type="number" class="form-control" name="jum_kls">
										</div>
									</div>
									<div class="row">
										<div class="form-group">
