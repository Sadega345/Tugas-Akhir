				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Apd_a712_excel/do_tambah"; ?>" method="POST">
							<div class="container">
								<div class="col-md-10">
									<div class="row">
									...
									<div class="row">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="publikasi" >
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label>Tahun Penyajian/Publikasi </label>
											<input type="text" class="form-control" name="thn_publikasi" >
										</div>
									</div>
									<div class="row">
										<div class="form-group">
