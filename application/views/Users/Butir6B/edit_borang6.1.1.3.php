				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Butir 6.1.1.3 : PENGGUNAAN DANA UNTUK TRIDARMA
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Aps_b6113_excel/do_edit"; ?>" method="POST">
