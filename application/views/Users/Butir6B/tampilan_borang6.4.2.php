				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Butir 6.4.2 : AKSESIBILITAS TIAP JENIS DATA
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<tr>
							 	...
							 	<?php 
							 	 ...
							 	 <td class="center">
									<a href="<?php echo base_url()."index.php/Aps_b642_excel/ubah/".$d['id'];?>" >Edit</a>
								</td>
							...
							<!-- <div class="btn-group">
								<a href="<?php echo base_url()."index.php/Apd_b642_excel/ubah";?>">
									<button id="sample_editable_1_new" class="btn green">
										Ubah 
									</button>
								</a>
							...
							<div class="btn-group">
								<a href="<?php echo base_url()."index.php/Aps_b642_excel/export_excel";?>">
