						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url()."index.php/Aps_a453_excel/tambah";?>">
							...
							?>
							 	...
							 	<td class="center">
									<a href="<?php echo base_url()."index.php/Aps_a453_excel/ubah/".$d['id'];?>" >Edit</a>
									||
									<a href="<?php echo base_url()."index.php/Aps_a453_excel/do_hapus/".$d['id'];?>">Hapus</a>
								</td>
							 </tr>
							 <?php } ?>
							</tbody>
							...
							<!-- <div class="btn-group">
								<a href="<?php echo base_url()."index.php/Apd_a453_excel/ubah";?>">
									<button id="sample_editable_1_new" class="btn green">
										Ubah 
									</button>
								</a>
							...
							<div class="btn-group">
								<a href="<?php echo base_url()."index.php/Aps_a453_excel/export_excel";?>">
