<!DOCTYPE html>
<title>Butir 4.4.2 : AKTIVITAS MENGAJAR DATA DOSEN TIDAK TETAP</title>
<!-- 
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Butir 4.4.2 : AKTIVITAS MENGAJAR DATA DOSEN TIDAK TETAP
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url()."index.php/Aps_a442_excel/tambah";?>">
							...
							?>
							 	...
							 	<td class="center">
									<a href="<?php echo base_url()."index.php/Aps_a442_excel/ubah/".$d['id'];?>" >Edit</a>
									||
									<a href="<?php echo base_url()."index.php/Aps_a442_excel/do_hapus/".$d['id']; ?>">Hapus</a>
								</td>
							 </tr>
							 <?php } ?>
							 <tr>
							...
							<!-- <div class="btn-group">
								<a href="<?php echo base_url()."index.php/Apd_a442_excel/ubah";?>">
									<button id="sample_editable_1_new" class="btn green">
										Ubah 
									</button>
								</a>
							...
							<div class="btn-group">
								<a href="<?php echo base_url()."index.php/Aps_a442_excel/export_excel";?>">
