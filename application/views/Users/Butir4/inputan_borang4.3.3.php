				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Aps_a433_excel/do_tambah"; ?>" method="POST">
							<div class="container">
								<div class="col-md-10">
									<div class="row">
										<div class="form-group">
											...
											<select name="id_dosen" class="form-control">
												...
												<?php 
													$data=$this->Aps_a433_model->getdosen();
													foreach($data as $d) { 
												?>
									...
									<div class="row">
										<div class="form-group">
											<label>SKS Pengajaran Pada PS Sendiri</label>
											<input type="number" class="form-control" name="sks_pss">
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label>SKS Pengajaran Pada PS Lain, PT Sendiri</label>
											<input type="number" class="form-control" name="sks_psl_pts">
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label>SKS Pengajaran Pada PT Lain</label>
											<input type="number" class="form-control" name="sks_ptl">
										</div>
									</div>
									<div class="row">
										<div class="form-group">
									...
									<div class="row">
										<div class="form-group">
											<label>SKS Pengabdian pada Masyarakat</label>
											<input type="number" class="form-control" name="sks_pp_mas">
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label>SKS Manajemen, PT Sendiri</label>
											<input type="number" class="form-control" name="sks_man_pts">
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label>SKS Manajemen, PT Lain</label>
											<input type="number" class="form-control" name="sks_man_ptl">
										</div>
									</div>
								</div>
							</div>
