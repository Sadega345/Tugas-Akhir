				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Aps_a453_excel/do_tambah"; ?>" method="POST">
							<div class="container">
								<div class="col-md-10">
									<div class="row">
										<div class="form-group">
											...
											<select name="id_dosen" class="form-control">
												...
												<?php 
													$data=$this->Aps_a453_model->getdosen();
													foreach($data as $d) { 
												?>
									...
									<div class="row">
										<div class="form-group">
											<label>Penyaji</label>
											<input type="checkbox" class="form-control" name="sbg_penyaji" value="v">
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label>Peserta</label>
											<input type="checkbox" class="form-control" name="sbg_peserta" value="v">
										</div>
									</div>
								</div>
							</div>
