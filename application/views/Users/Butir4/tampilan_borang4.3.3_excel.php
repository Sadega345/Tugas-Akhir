...
<thead>
							...
							<tr>
							 ...
							 <tr>
							 	<td colspan="2"  bgcolor="#D3D3D3"><strong>Jumlah</strong></td>
							 	<?php 
									foreach ($jumlah_pssendiri as $h ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo $h['jml']; ?></td>
							 	<?php } ?>
							 	<?php 
									foreach ($pt as $p ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo $p['jml']; ?></td>
							 	<?php } ?>
							 	<?php 
									foreach ($lain as $l ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo $l['jml']; ?></td>
							 	<?php } ?>
							 	<?php 
							 	...
							 	<?php 
									foreach ($jumsks as $j ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo $j['jml']; ?></td>
							 	<?php } ?>
							 	<?php 
									foreach ($manptlain as $man ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo $man['jml']; ?></td>
							 	<?php } ?>
							 	<?php 
									foreach ($totsks as $tot ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo $tot['jml']; ?></td>
							 	<?php } ?>
							 </tr>
							 
							  <tr>
							 	<td colspan="2" bgcolor="#D3D3D3"><strong>Rata-rata</strong></td>
							 	<?php 
									foreach ($rata as $r ) { 
							  	?>
							 	...
							 	<?php 
							  	...
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo number_format((double)$pr['rata'],2,',',','); ?></td>
							 	<?php } ?>

							 	<?php 
									foreach ($ptlain as $pt ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo number_format((double)$pt['rata'],2,',',','); ?></td>
							 	<?php } ?>

							 	<?php 
									foreach ($ratapenelitian as $rp ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo number_format((double)$rp['rata'],2,',',','); ?></td>
							 	<?php } ?>

							 	<?php 
									foreach ($pengmas as $peng ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo number_format((double)$peng['rata'],2,',',','); ?></td>
							 	<?php } ?>

							 	<?php 
									foreach ($rataman as $m ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo number_format((double)$m['rata'],2,',',','); ?></td>
							 	<?php } ?>

							 	<?php 
									foreach ($manlain as $ml ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo number_format((double)$ml['rata'],2,',',','); ?></td>
							 	<?php } ?>

							 	<?php 
									foreach ($ratajumsks as $ratasks ) { 
							  	?>
							 	<td bgcolor="#9ACD32"><?php echo number_format((double)$ratasks['rata'],2,',',','); ?></td>
							 	<?php } ?>
