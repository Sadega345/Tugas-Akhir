						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url()."index.php/Aps_a452_excel/tambah";?>">
							...
							<tr>
								...
								?>
								 	...
								 	<td class="center">
										<a href="<?php echo base_url()."index.php/Aps_a452_excel/ubah/".$d['id'];?>" >Edit</a>
									</td>
								 </tr>
							</tbody>
							...
							<div class="btn-group">
								<a href="<?php echo base_url()."index.php/Aps_a452_excel/export_excel";?>">
