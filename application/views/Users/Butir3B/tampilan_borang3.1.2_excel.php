...
<thead>
								<tr>
									 ...
									 <th rowspan="2" colspan="2" bgcolor="#D3D3D3"><center>Hal</center></th>
									 <th rowspan="2" bgcolor="#D3D3D3"><center>Total Mahasiswa pada Fakultas**</center></th>
									 <th bgcolor="#D3D3D3"><center>Jumlah Mahasiswa pada PS: *</center></th>
								 </tr>
								 <tr>
								 <?php 
								 	$no=1;
							...
							<tbody>
								...
								<tr>
									...
									<?php 
									 ...
									 ?>
									<td bgcolor="#9ACD32"><?php echo $t['totalnonreg1']; ?></td>
									<?php } ?>
									<?php 
								...
								<tr>
									...
									<?php foreach ($totalnonreg2 as $t) {
									 ?>
									<td bgcolor="#9ACD32"><?php echo $t['totalnonreg2']; ?></td>
									<?php } ?>
								...
								<tr>
									...
									<?php foreach ($totalnonreg3 as $t) {
									 ?>
									<td bgcolor="#9ACD32"><?php echo $t['totalnonreg3']; ?></td>
									<?php } ?>
