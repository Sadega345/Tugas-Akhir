					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<tbody>
								 ...
								 ?>
								<tr>
									<td><?php echo $d['jenis_pustaka']; ?></td>
									<td><?php echo $d['jml_judul']; ?></td>
									<td><?php echo $d['jml_copy']; ?></td>
									<td class="center">
										<a href="<?php echo base_url()."index.php/Aps_a6411_excel/ubah/".$d['id'];?>" >Edit</a>
									</td>
								</tr>
								<?php } ?>
								<tr>
									...
									<?php 
										foreach ($total as $t) {
									 ?>
									 <td><?php echo $t['total_judul']; ?></td>
									 <td><?php echo $t['total_copy']; ?></td>
									 <?php } ?>
								</tr>
							</tbody>
							</table>
							<div class="btn-group">
								<a href="<?php echo base_url()."index.php/Aps_a6411_excel/export_excel";?>">
