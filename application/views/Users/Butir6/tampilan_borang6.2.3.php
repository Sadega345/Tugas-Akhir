<!DOCTYPE html>
<title>Butir 6.2.3 : DANA PELAYANAN/PENGABDIAN KEPADA MASYARAKAT</title>
<!-- 
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Butir 6.2.3 : DANA PELAYANAN/PENGABDIAN KEPADA MASYARAKAT
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url()."index.php/Aps_a623_excel/tambah";?>">
							...
							<tr>
							 	...
							 	<td class="center">
									<a href="<?php echo base_url()."index.php/Aps_a623_excel/ubah/".$d['id'];?>" >Edit</a>
									||
									<a href="<?php echo base_url()."index.php/Aps_a623_excel/do_hapus/".$d['id'];?>" >Hapus</a>
								</td>
							 </tr>
							 <?php } ?>
							 <tr>
							...
							<div class="btn-group">
								<a href="<?php echo base_url()."index.php/Aps_a623_excel/export_excel";?>">
