				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>BUTIR 5.1.2.2 : STRUKTUR KURIKULUM BERDASARKAN URUTAN MK
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url()."index.php/Aps_a5122_excel/tambah";?>">
							...
							<br><br>
							<div class="btn-group">
								<a href="<?php echo base_url()."index.php/Aps_a5122_excel/export_excel";?>">
