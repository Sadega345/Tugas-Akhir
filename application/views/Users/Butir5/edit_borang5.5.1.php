				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Aps_a551_excel/do_edit"; ?>" method="POST">
							...
							<tbody>
								 ...
								 <tr>
								 	...
								 	<td><input type="text" name="jml_mhs" value="<?php echo $jml_mhs; ?>" class="form-control"></td>
