				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form action="<?php echo base_url()."index.php/Aps_a552_excel/do_edit"; ?>" method="POST">
							...
							<tr>
							 	...
							 	<td><input type="text" name="jml_mhs" class="form-control" value="<?php echo $jml_mhs; ?>"></td>
							 </tr>	
							</tbody>
							</table>
							</div>
